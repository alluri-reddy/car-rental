    ...
    <div class="flex md:flex-row flex-col justify-between max-w-screen-xl md:px-16 px-8 mx-auto gap-12 ">
            ...
            <form action="#" class="space-y-8" id="contact-form">
                <div class="flex justify-between">
                    <div class="w-full mr-5">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">First
                            Name</label>
                ...
                <div class="flex justify-between">
                    ...
                    <div class="w-full ">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Phone
                            Number</label>
                        <input type="text" id="name"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="+91 9392xxxxxx" required>
                    </div>
                </div>
                <div>
                    <label for="subject"
        ...
        <div class="grid mx-auto text-center gap-4 ">
            <div>
                ...
                <p class="text-sm font-light text-gray-700 font-car">Location: Hyderabad</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="text-sm font-light text-gray-700 font-car">Mint Compound, 6-1-91, Saifabad, Khairtabad, Hyderabad, Telangana 500004</p>
                <p class="text-sm font-light text-gray-700 font-car">Zip Code/Postal code:500004</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="font-car text-pr-400 ">+91 93392xxxxxx</p>
            </div>
