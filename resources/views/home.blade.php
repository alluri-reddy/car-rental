                    ...
                    <div
                        ...
                        <div class="mt-4 px-5 pb-5">
                            ...
                            <div class="mt-2 mb-5 flex items-center justify-between">
                                <p>
                                    <span class="text-3xl font-bold text-slate-900">₹ {{ $car->price_per_day * 1000 }}</span>
                                    <span
                                        class="text-sm text-slate-900 line-through">₹ {{ intval(($car->price_per_day * 100) * 1000 / (100 - $car->reduce)) }}
                                    </span>
                                </p>
