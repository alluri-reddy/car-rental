    ...
    <div class="container">
        ...
        <div class="inv-header">
            <div>
                ...
                <ul>
                    <li>Hyderabad </li>
                    <li>Mint Compound, 6-1-91, Saifabad, Khairtabad, Hyderabad, Telangana 500004</li>
                    <li>+91 99499xxxxxx | contact.alluri770@gmail.com</li>
                </ul>
                <h2>Client</h2>
                <ul>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ $reservation->price_per_day * 1000 }} ₹ </td>
                        <td>{{ $reservation->total_price * 1000 }} ₹ </td>
                    </tr>
        ...
        <div class="inv-footer">
            ...
            <div>
                <table>
                    ...
                    <tr>
                        <th>tax</th>
                        <td>(15%) {{ intval($reservation->total_price - ($reservation->total_price * 85) * 1000 / 100) }}  ₹
                        </td>
                    </tr>
                    <tr>
                        <th style="color: #ff9b00">Total to pay</th>
                        <td>{{ $reservation->total_price - ($reservation->total_price * 85) / 100 + $reservation->total_price * 1000 }}
                            ₹</td>
                    </tr>
                </table>
            </div>
